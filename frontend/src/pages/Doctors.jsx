    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className={`flex-col gap-4 text-sm text-gray-600 ${showFilter ? 'flex' : 'hidden sm:flex'}`}>
          ...
          {/*agar ham dubara usi option pe click karenge to speciality match karegi aur wo hame sabhi doctor ka data dubara de dega*/ }
        ...
        <div className='w-full grid grid-cols-[repeat(auto-fill,_minmax(200px,_1fr))] gap-4 gap-y-6'>          {filterDoc.map((item, index) => (
